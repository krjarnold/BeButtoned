	...
	class View {
	  ...
	  render(type) {
	    ...
	    if (type === "board") {
	      ...
	      // $(".score-text-num").replaceWith('<p>'+this.game.score+'</p>').addClass("score-text");
	    }
	    ...
	    if (type === "start") {
	      ...
	      // $(this.score).append('<p>Score</p>').addClass("score-text");
	      // $(this.score).append('<p>'+this.game.score+'</p>').addClass("score-text-num");
	      // $("ul").append(this.score);
